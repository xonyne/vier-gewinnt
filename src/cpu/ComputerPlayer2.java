...
// Einen 3er bauen - waagrecht ->
		for(row=0 ; row<6 ; row++){
			...
			for(column=0 ; column<7 ; column++){
				if (board[column][row]==token.player2) {pl2++;}
				if (board[column][row]!=token.player2) {pl2=0;}
				if (pl2==2 && column<6 && (board[column+1][row]==token.empty)) {return column+1;}
			}
		}
...
//		senkrecht		
		for (column=0 ; column<7 ; column++){
			...
			for(row=0 ; row<6 ; row++){
				if (board[column][row]==token.player2) {pl2++;}
				if (board[column][row]!=token.player2) {pl2=0;}
				if (pl2==2 && row<5 && (board[column][row+1]==token.empty)) {return column;}
			}
		}
...
//einen 4er des hp verhindern - waagrecht ->
		...
		for(row=0 ; row<6 ; row++){
			...
			for(column=0 ; column<7 ; column++){
				if (board[column][row]==token.player1) {pl1++;}
				if (board[column][row]!=token.player1) {pl1=0;}
				if (pl1==2 && column<6 && (board[column+1][row]==token.empty)) {return column+1;}
			}
		}
//		waagrecht <-
		for(row=0 ; row<6 ; row++){
			...
			for(column=6 ; column>0 ; column--){
				if (board[column][row]==token.player1) {pl1++;}
				if (board[column][row]!=token.player1) {pl1=0;}
				if (pl1==2 && (board[column-1][row]==token.empty)) {column=column-1 ; return column;}
			}
		}
...
//		senkrecht
		for(column=0 ; column<7 ; column++){
			...
			for(row=0 ; row<6 ; row++){
				if (board[column][row]==token.player1) {pl1++;}
				if (board[column][row]!=token.player1) {pl1=0;}
				if (pl1==2 && row<5 && (board[column][row+1]==token.empty)) {return column;}
			}
		}
