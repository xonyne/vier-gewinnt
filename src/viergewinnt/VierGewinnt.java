...
public class VierGewinnt {
	...
	public void play() {
		...
		if (solved) { 
			...
			if (players[currentPlayer].getToken() == Token.player1) pl1wins++; 
			else pl2wins++;
			if (players[currentPlayer].getProgrammers()=="Random") randomWins=true;
		}
		else { 
			draws++;
...
private boolean checkVierGewinnt(int col, int row){
	...
	public static void main(String args[]){
		...
		if (pl1==0 || pl2==0) humanPlays=true;
		else {
			...
			if (answer.toLowerCase().equals("y")) stopSimulation = true;
		}
		
		
		
		switch (pl1) {
			case 0: players[0] = new HumanPlayer(); break;	
			case 1: players[0] = new ComputerPlayerRandom(); break;
			case 2: players[0] = new ComputerPlayer(); break;
			case 3: players[0] = new ComputerPlayer2(); break;
			case 4: players[0] = new ComputerPlayer3(); break;
			case 5: players[0] = new ComputerPlayer4(); break;
		}
		
		switch (pl2) {
			case 0: players[1] = new HumanPlayer(); break;	
			case 1: players[1] = new ComputerPlayerRandom(); break;
			case 2: players[1] = new ComputerPlayer(); break;
			case 3: players[1] = new ComputerPlayer2(); break;
			case 4: players[1] = new ComputerPlayer3(); break;
			case 5: players[1] = new ComputerPlayer4(); break;
		}
		
		VierGewinnt game = new VierGewinnt();
		
		if (humanPlays) game.play();
		else {
